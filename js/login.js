...
const demoUsers = [
  { email: 'demo@sportzone.vn', password: 'Sport@123' },
  { email: 'admin@sportzone.vn', password: 'Admin@123' },
...
function showSuccessOverlay() {
  ...
  setTimeout(() => {
    ...
    alert('✅ Chuyển hướng đến trang chủ...\n\nTrong dự án thật: window.location.href = "index.html"');
  }, 1500);
}
...
loginForm.addEventListener('submit', (event) => {
  ...
  setTimeout(() => {
    ...
    showAlert('Email hoặc mật khẩu không chính xác. Thử: demo@sportzone.vn / Sport@123 hoặc user1@gmail.com / 123456');
